...
bool validSlot(const QMetaMethod &method, QObjectBinding::AccessFlags accessflags)
{
    ...
    case QMetaMethod::Private: {
        if (!(accessflags & QObjectBinding::PrivateSlots)) {
            return false;
        }
    } break;
    case QMetaMethod::Protected: {
        if (!(accessflags & QObjectBinding::ProtectedSlots)) {
            return false;
        }
    } break;
    case QMetaMethod::Public: {
        if (!(accessflags & QObjectBinding::PublicSlots)) {
            return false;
        }
    } break;
    }
    if (method.attributes() & QMetaMethod::Scriptable) {
        if (!(accessflags & QObjectBinding::ScriptableSlots)) {
            return false;
        }
    } else {
        if (!(accessflags & QObjectBinding::NonScriptableSlots)) {
            return false;
        }
    }
    return true;
...
bool validSignal(const QMetaMethod &method, QObjectBinding::AccessFlags accessflags)
{
    switch (method.access()) {
    case QMetaMethod::Private: {
        if (!(accessflags & QObjectBinding::PrivateSignals)) {
            return false;
        }
    } break;
    case QMetaMethod::Protected: {
        if (!(accessflags & QObjectBinding::ProtectedSignals)) {
            return false;
        }
    } break;
    case QMetaMethod::Public: {
        if (!(accessflags & QObjectBinding::PublicSignals)) {
            return false;
        }
    } break;
    }
    if (method.attributes() & QMetaMethod::Scriptable) {
        if (!(accessflags & QObjectBinding::ScriptableSignals)) {
            return false;
        }
    } else {
        if (!(accessflags & QObjectBinding::NonScriptableSignals)) {
            return false;
        }
    }
    return true;
...
bool validProperty(const QMetaProperty &property, QObjectBinding::AccessFlags accessflags)
{
    if (property.isScriptable()) {
        if (!(accessflags & QObjectBinding::ScriptableProperties)) {
            return false;
        }
    } else {
        if (!(accessflags & QObjectBinding::NonScriptableProperties)) {
            return false;
        }
    }
    return true;
